...
HERE.
In terms of significant estimators this meant, distance to the coastline, and industry contribution to GDP (%), for date palms; and distance to the coastline, population, and industry contribution to GDP (%), for canary palms. Appendix D summarises the tables used for model selection with table \ref{tab:date_palms_model} and \ref{tab:canary_palms_model} summarising the model estimates for date and canary palms, respectively.
