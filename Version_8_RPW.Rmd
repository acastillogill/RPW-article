...
The selected policies aim to mitigate impact on susceptible palm species caused by the RPW. We will use a cost-benefit analysis as a tool to assess the selected policies since it has recently been highlighted to overcome "pitfalls" present in other methods: (1) prioritisations are sometimes based on expert judgements and scores are debatable, (2) scores summation is difficult, (3) inclusion of management expenditure is not usual, and (4) relationships between species are often excluded [@courtoisCostBenefitApproach2018].
...
Some areas in the Mediterranean have also been colonised by the pest. Sicily, for instance, was reached in 2005 where palm damage was categorised as a threat to cultural heritage [@manachiniExoticInsectPests2013; @periRedPalmWeevil2013]. Other countries where it appeared for the first time in this period include Turkey (2005), Cyprus (2006), Greece (2006) and Malta (2007) [@mizziRedPalmWeevil2009; @yuezhongRedPalmWeevil2009].
...
============
We will perform a cost-benefit analysis assessing a set of conservation policies put into place to protect susceptible species from the RPW. Based on the policies selected, two species appear: canary and date palms [@generalitatdecatalunyaOrdreARP3432006]. The former was reported in 99.69% and the latter in 0.23% of RPW infestation cases in Catalonia [@generalitatdecatalunyaPrevencioLluitaContra2011]. Although date palms currently represent a small fraction of reports, we include them because in absence of canary palms, the RPW would likely shift to that species. 
The first step of a cost benefit analysis is to define what constitute as costs and benefits. We interpret as costs all policy expenditures with the direct aim of preserving and protecting palm trees from the RPW. The following activities fall into the management category and include: prevention and inspection of healthy palms, treatment of infested palms and removal of palms that are too infested to be salvaged. However, according to our definition, costs also include government expenditure associated to survey, research, regulation, management and outreach linked to the RPW [@aukemaEconomicImpactsNonNative2011]. To better understand the rationale behind the accounting used in this study, a few points are made on the policies. The main variation in terms of the funding agent is that in 2011, inspection, prevention, treatment and removal costs were transferred from the Catalonian goverment (GENCAT), to municipalities and private owners. From 2005 to 2011, GENCAT was responsible for research and outreach in addition to the management activities described (excluding replanting). From 2011, onwards, municipalities and property owners are responsible for management activities while GENCAT continues funding research and outreach for the pest. Although replanting is not explicit in the policies, between 2005 to present, replanting has not been null albeit total stock or rates unknown [@congostrinaBarcelonaPlantaPalmeras2017; @puricaroBarcelonaAtesora242017], we therefore include replanting on behalf of municipalities and property owners throughout the entire period.
...
\caption{Total economic value framework for canary and date palms in Catalonia. For use values, we identify as indirect benefits, aesthetic values and carbon sequestration. Direct values are unknown.}
\label{fig:tev}
\end{figure}
...
In this section we will present calculations for costs, benefits, and the related cost-benefit analysis (Eq. \ref{eq:nsb}). In this section, tables and figures show aggregated results, for detailed tables and figures refer to Appendix C. Recall, we considered two types of benefits provided by palm trees (Eq. \ref{eq:benefits}), those derived from carbon sequestration and others derived from palm tree adjacency. Here we present the results for both calculations. 
...
3.2 Carbon sequestration benefits
============
