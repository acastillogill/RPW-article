...
kable(
  df_nurseries,
  caption = "Gardens, nurseries and plant traders in Catalonia per Administrative Region.",
  booktabs = T,
  escape = F
) %>%
  kable_styling(latex_options = c("hold_position"))%>%
  footnote(general="Source: GENCAT, 2018.",
           general_title = "",
...
\subsubsection{Carbon sequestration benefits}
...
\subsubsection{Property values benefits}
